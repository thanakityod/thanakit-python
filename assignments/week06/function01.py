...
def calculate_circle(radius):
    ...
    return {
        "area" : area,
        "circuference" : round*(circuference,2)
    }
...
def create_user_profile(username, age=18, premium=False):
    ...
    if premium:
        ...
        return username + "(age:" + age +"-Standrad User"
...
def count_vowels_consonants(text):
    ...
    text = text.replace(" ","")
    text = text.lower('a') + text.count('e')+ text.count('i')+ text.count('o')+ text.count('u')
    number = text.lower(0') + text.count('1')+ text.count('2')+ text.count('3')+ text.count('4')+ text.count('5')+ text.count('6')+ text.count('7')+ text.count('8')+ text.count('9')
